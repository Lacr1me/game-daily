...
固定生成35条且不得重复：
1. domestic 中国时政与民生10条：优先当天或前一天，不足才用近7天；聚焦就业、收入、社保、医保、养老、教育、住房、物价、消费、交通、公共安全、公共服务和生态环境；优先中国政府网、新华社、人民日报、央视及国务院部门和省级政府官网。
2. international 全球国际10条：优先当天或前一天，不足用近7天；国家与议题均衡；冲突、伤亡、制裁、选举至少核对原始机构或两家独立权威媒体。
3. tech 中国科技10条：仅限近7天中国机构、高校或企业主导的实质性科研与工程进展；论文优先引用期刊、论文或科研机构页面，禁止把营销和融资写成科研突破。
4. ai AI科技5条：仅限近7天的模型、算法、芯片、机器人、AI安全、论文或开发平台重要更新；明确正式发布、预览、开源或预印本状态。
